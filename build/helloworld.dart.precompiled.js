...
return}throw "Unable to print message: " + String(a)}}],["","file:///home/codebox/workspace/web/helloworld.dart",,Q,{
"":"",
Iq:[function(){var z=document.querySelector("#sample_text_id")
z.textContent="Click me!"
z.toString
z=H.VM(new W.Cq(z,C.T1.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(Q.EB()),z.Sg),[H.Kp(z,0)]).Zz()},"call$0","eE",0,0,0],
qd:[function(a){var z,y,x,w
z=document.querySelector("#sample_text_id").textContent
y=P.p9("")
for(x=z.length-1;x>=0;--x){w=z[x]
y.vM=y.vM+w}document.querySelector("#sample_text_id").textContent=y.vM},"call$1","EB",2,0,8]},1],])
...
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"bB",void:true,args:[W.Aj]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"BG",args:[null],opt:[null]},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
